    ...
    <AboutWrapper id="about">
      <AboutContainer shouldFade={shouldFadeAbout}>
        ...
        <FadeContainer shouldFade={shouldFadeAbout2}>
          <AboutMeDescription>
            Hello! 😊 My name is Lance Gomes and I am an Engineering grad from the University of Waterloo
          </AboutMeDescription>
        </FadeContainer>
        ...
        <FadeContainer shouldFade={shouldFadeAbout5}>
          <AboutMeDescription>
            I also have over five years of experience solving a wide variety of problems using Java, Python, and C
          </AboutMeDescription>
        </FadeContainer>
