...
const ExperienceTimeline = () => {
  ...
  return (
    <Timeline lineColor={'#ddd'} style={{ paddingTop: '0' }}>
      <TimelineItem
        key="001"
        dateText="Aug 2021 – Present"
        dateInnerStyle={{ background: 'rgb(47, 183, 236)', color: 'white' }}
        style={{ color: 'rgb(47, 183, 236)' }}
      >
        <h3>Wish - <i>Software Engineer</i></h3>
        <h4>Product Web</h4>
        <h5 style={{ paddingTop: '4px' }}>Python, MongoDB, ReactJS, Redux</h5>
        <p>
          Currently working fulltime on <Link href="https://www.wish.com/">Wish</Link>'s web payments team.
        </p>
      </TimelineItem>
      <TimelineItem
        key="001"
        dateText="Sep 2020 – Dec 2020"
        dateInnerStyle={{ background: 'rgb(47, 183, 236)', color: 'white' }}
        style={{ color: 'rgb(47, 183, 236)' }}
      >
        ...
        <p>
          I returned to <Link href="https://www.wish.com/">Wish</Link> for a second internship
          as an engineer on the product web team. This term, I had the
        ...
        <p>
          In addition to this, I built out several features supporting legal VAT requirements in Europe. I also worked on implementing Wish's credit card installments feature in the US.
        </p>
      </TimelineItem>
      <TimelineItem
        key="002"
      ...
      >
        ...
        <p>
          ...
          I worked on several features, and was responsible for implementing a service allowing users to automatically install products Oracle Marketing Products to their applications.
        </p>
      </TimelineItem>
      <TimelineItem
        key="005"
